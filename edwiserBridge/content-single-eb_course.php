...
if (is_array($terms)) {
    foreach ($terms as $term) {
        ...
        $categories[] = '<a href="'.esc_url($lnk).'" target="_blank" rel="noopener noreferrer">'.$term->name.'</a>';
    }
}
    ...
    <div>
        <div class="eb-course-img-wrapper">
            ...
            if (has_post_thumbnail()) {
                ...
                echo '<img src="'.get_course_random_image_url().'" />';
            }
            ?>
        </div>
        ...
        <div class="eb-course-summary">
            ...
            if (!is_search()) {
                ...
                echo get_elebe_inscripcion_form();
